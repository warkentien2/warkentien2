          ...
          <div className="container">     
            <div className="row contain">
              <div className="col-6 col-wrap right contact-list contact-list--left">
                <h4>Find me:</h4>
                <ul>
                  <li className="contact"><a href="https://codepen.io/warkentien2/" target="_blank" rel="noopener noreferrer">playground <span className="horizontal-spacer"><i className="fab fa-codepen"></i></span></a></li>
                  <li className="contact"><a href="https://www.codewars.com/users/warkentien2" target="_blank" rel="noopener noreferrer">
                    training <span className="horizontal-spacer"><svg viewBox="0 0 5120 5120">
                  ...
                  <li className="contact"><a href="https://stackoverflow.com/users/4714084/warkentien2" target="_blank" rel="noopener noreferrer">helping others <span className="horizontal-spacer"><i className="fab fa-stack-overflow"></i></span></a></li>
                  <li className="contact"><a href="https://www.deviantart.com/warkentien2/gallery/" target="_blank" rel="noopener noreferrer">some art <span className="horizontal-spacer"><i className="fab fa-deviantart"></i></span></a></li>
                </ul>
              </div>
              <div className="col-6 col-wrap contact-list contact-list--right">
                <h4>Reach out:</h4>
                <ul>
                  <li className="contact"><strong className="highlight"><a href="mailto:philip.dw2@gmail.com?Subject=Job%20Offer" target="_top"><span className="horizontal-spacer"><i class="fas fa-envelope"></i></span> philip.dw2<br />@gmail.com</a></strong></li>
                  <li className="contact"><a href="https://www.linkedin.com/in/warkentien2/" target="_blank" rel="noopener noreferrer"><span className="horizontal-spacer"><i className="fab fa-linkedin-in"></i></span> business</a></li>
                  <li className="contact"><a href="https://twitter.com/warkentien2" target="_blank" rel="noopener noreferrer"><span className="horizontal-spacer"><i class="fab fa-twitter"></i></span> casual</a></li>
                </ul>        
              </div>
            </div>
