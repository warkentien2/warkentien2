...
function addWidthMetadata(tarantula) {
  ...
  legs.forEach((leg) => {
    const legPartsNodeList = leg.querySelectorAll(
      ".x-femur, .x-patella, .x-tibia"
    );
...
function animateBodyPart(node, speed, angle, newWidth = false, offset = 0) {
  ...
  return speed > 0
    ? TweenMax.to(node, speed, animation)
    : TweenMax.set(node, animation);
}

function animateLeg(
  leg,
  speed,
  angles = [false, false, false, false, false, false],
  scalePatellaPercent = false,
  scaleFemurPercent = false
) {
  ...
  const [coxa, femur, patella, tibia, metatarsus, tarsus] = angles.map(
    (angle, index) => {
      if (angle !== false) {
  ...
  if (scalePatellaPercent) {
    scalePatella = Math.abs(
      (patella.dataset.width * scalePatellaPercent) / 100
    );
    scaleTibia = Math.abs((tibia.dataset.width * scalePatellaPercent) / 100);
  }

  // moves leg parts on the x axis
  const offset = scalePatellaPercent
    ? ((100 - scalePatellaPercent) * 1) / 5
    : false;

  tl.addLabel("move");
  if (coxa) tl.add(animateBodyPart(coxa, speed, angles[0]), "move");
  if (femur)
    tl.add(animateBodyPart(femur, speed, angles[1], scaleFemur), "move");
  if (patella)
    tl.add(
      animateBodyPart(patella, speed, angles[2], scalePatella, offset),
      "move"
    );
  if (tibia)
    tl.add(animateBodyPart(tibia, speed, angles[3], scaleTibia), "move");
  if (metatarsus)
    tl.add(
      animateBodyPart(metatarsus, speed, angles[4], scaleMetatarsus, -offset),
      "move"
    );
...
function rotateBody(
  ...
  if (abdomenAngle)
    tl.add(animateBodyPart(abdomen.current, speed, 10 + abdomenAngle), "move");
  ...
  tl.add(
    animateBodyPart(legA3.current, speed, {
      rotationZ: 180 - 20 - 1.3 * angle,
    }),
    "move"
  );
  tl.add(
    animateBodyPart(legB3.current, speed, {
      rotationZ: 180 - 15 - 0.85 * angle,
    }),
    "move"
  );
  tl.add(
    animateBodyPart(legA4.current, speed, {
      rotationZ: 180 - 2 - 1.12 * angle,
    }),
    "move"
  );
  tl.add(
    animateBodyPart(legB4.current, speed, { rotationZ: -1.35 * angle }),
    "move"
  );
  ...
  if (showFangs) {
    ...
    tl.add(
      animateBodyPart(cheliceraeA.current.querySelector(".x-fang"), speed, 47),
      "move"
    );
    tl.add(animateBodyPart(cheliceraeB.current, speed, -10), "move");
    tl.add(
      animateBodyPart(cheliceraeB.current.querySelector(".x-fang"), speed, 60),
      "move"
    );
  }
...
const animateLegA1 = {
  ...
  raise: (el, time) =>
    animateLeg(el, time, [
      26,
      -142,
      tools.randomChoice([72, 87, 62]),
      15,
      tools.randomChoice([56, 66, 36]),
      -10,
    ]),
  stretch: (el, time) => animateLeg(el, time, [13, -82, 32, 15, 22, -25]),
  halfAttackStance: (el, time) =>
    animateLeg(el, time, [
      -20,
      -127,
      tools.randomChoice([97, 92]),
      15,
      tools.randomChoice([10, 15, 26]),
      -15,
    ]),
  attackStance: (el, time) =>
    animateLeg(el, time, [
      -50,
      -122,
      tools.randomChoice([62, 67]),
      15,
      tools.randomChoice([30, 35, 46]),
      -25,
    ]),
  wiggleStance: (el, time) =>
    animateLeg(
      el,
      time,
      [
        -50,
        -122,
        tools.randomChoice([62, 67, 75, 83, 95]),
        15,
        tools.randomChoice([30, 35, 46, 50, 55]),
        tools.randomChoice([5, -5, -15, -25]),
      ],
      95
    ),
};
...
const animateLegB1 = {
  ...
  attackStance: (el, time) =>
    animateLeg(el, time, [
      -50,
      -143,
      tools.randomChoice([87, 82]),
      15,
      tools.randomChoice([50, 55, 60]),
      -20,
    ]),
  wiggleStance: (el, time) =>
    animateLeg(
      ...
      [
        -50,
        -143,
        tools.randomChoice([60, 75, 87, 82]),
        15,
        tools.randomChoice([40, 50, 55, 60]),
        tools.randomChoice([5, -10, -15, -20]),
      ],
      95
    ),
};
...
const animateLegA2 = {
  ...
  raise: (el, time) =>
    animateLeg(
      ...
      [
        20,
        -127,
        tools.randomChoice([60, 55, 80]),
        15,
        tools.randomChoice([88, 92, 52]),
        5,
      ],
      80
    ),
  stretch: (el, time) =>
    animateLeg(
      el,
      time,
      [10, -87, 60, 15, tools.randomChoice([45, 30]), -30],
      100
    ),
  halfAttackStance: (el, time) =>
    animateLeg(el, time, [27, -75, 96, 15, 43, -25], 100, 160),
  attackStance: (el, time) =>
    animateLeg(el, time, [30, -92, 159, 15, 10, -5], 105, 110),
};
...
const animateLegB2 = {
  ...
  raise: (el, time) =>
    animateLeg(
      ...
      [
        10,
        -110,
        tools.randomChoice([57, 52, 77]),
        15,
        tools.randomChoice([98, 103, 63]),
        5,
      ],
      80
    ),
  stretch: (el, time) =>
    animateLeg(
      el,
      time,
      [0, -79, 57, 15, tools.randomChoice([47, 32]), -30],
      100
    ),
  halfAttackStance: (el, time) =>
    animateLeg(el, time, [17, -95, 91, 15, 55, -30], 100, 160),
  attackStance: (el, time) =>
    animateLeg(el, time, [25, -155, 146, 16, 7, -5], 105, 110),
};
...
const animateLegA3 = {
  ...
  halfAttackStance: (el, time) =>
    animateLeg(el, time, [70, -153, 153, 15, 0, 0], 62),
  attackStance: (el, time) =>
    animateLeg(el, time, [-10, -63, 155, 10, 12, -10], 75, 185),
};

const animateLegB3 = {
  step: (el, time) =>
    animateLeg(el, time, [10, -135, 165, 20, 15, 10], 35, 185),
  ...
  halfAttackStance: (el, time) =>
    animateLeg(el, time, [50, -153, 133, 15, 42, -30], 71),
  attackStance: (el, time) =>
    animateLeg(el, time, [-20, -73, 133, 15, 12, -30], 65, 130),
};
...
const animateLegA4 = {
  ...
  halfAttackStance: (el, time) =>
    animateLeg(el, time, [10, -48, 51, 15, 50, -20]),
...
const animateLegB4 = {
  ...
  halfAttackStance: (el, time) =>
    animateLeg(el, time, [0, -40, 62, 15, 65, -22]),
...
const animatePedipalpA = {
  ...
  halfAttackStance: (el, time) =>
    animateLeg(el, time, [false, -115, 107, 20, 60, false]),
  resting: (el, time) => animateLeg(el, time, [false, -90, 132, 30, 25, false]),
  attackStance: (el, time) =>
    animateLeg(el, time, [false, -155, 72, 20, -10, false]),
  wiggleStance: (el, time) =>
    animateLeg(el, time, [
      false,
      tools.randomChoice([-155, -157, -145]),
      tools.randomChoice([72, 82, 62]),
      tools.randomChoice([20, 25, 30]),
      tools.randomChoice([20, 10, 0, -10]),
      false,
    ]),
};
...
const animatePedipalpB = {
  ...
  stretch: (el, time) => animateLeg(el, time, [false, -25, 52, 20, -25, false]),
  halfAttackStance: (el, time) =>
    animateLeg(el, time, [false, -110, 102, 20, 40, false]),
  resting: (el, time) => animateLeg(el, time, [false, -90, 132, 30, 20, false]),
  attackStance: (el, time) =>
    animateLeg(el, time, [false, -180, 57, 20, -10, false]),
  wiggleStance: (el, time) =>
    animateLeg(el, time, [
      false,
      tools.randomChoice([-180, -182, -170]),
      tools.randomChoice([57, 47, 62]),
      tools.randomChoice([20, 25, 30]),
      tools.randomChoice([15, 5, -5, -10]),
      false,
    ]),
};
...
function legCycle(leg, options = false) {
  ...
  if (moveFirst && raiseLate) {
    ...
    if (steps >= 2)
      tl.add(animateObjects[legId].raise(leg, 0.25), "cycle+=0.5");
    if (steps >= 3)
      tl.add(animateObjects[legId].stretch(leg, 0.5), "cycle+=0.75");
    if (steps >= 4)
      tl.add(animateObjects[legId].step(leg, 0.25), "cycle+=1.25");
    ...
    if (steps >= 2)
      tl.add(animateObjects[legId].raise(leg, 0.25), "cycle+=0.75");
    if (steps >= 3)
      tl.add(animateObjects[legId].stretch(leg, 0.25), "cycle+=1");
    if (steps >= 4)
      tl.add(animateObjects[legId].step(leg, 0.25), "cycle+=1.25");
    ...
    if (steps >= 2)
      tl.add(animateObjects[legId].stretch(leg, 0.25), "cycle+=0.5");
    if (steps >= 3)
      tl.add(animateObjects[legId].step(leg, 0.25), "cycle+=0.75");
    ...
    if (steps >= 2)
      tl.add(animateObjects[legId].stretch(leg, 0.25), "cycle+=0.25");
    if (steps >= 3) tl.add(animateObjects[legId].step(leg, 0.25), "cycle+=0.5");
    if (steps >= 4)
      tl.add(animateObjects[legId].move(leg, 0.75), "cycle+=0.75");
...
function Tarantula({ isMobile }) {
  ...
  useEffect(() => {
    ...
    // animation
    singlePulseTl.addLabel("pulse").to(
      body.current,
      2.25,
      {
        onStart: (self) => {
    ...
    pulseTl.addLabel("keep-on-pulsing").to(
      singlePulseTl,
      2.25,
      {
        progress: 1,
    ...
    walkMidStanceTl
      ...
      .to(
        tarantula.current,
        0.725,
        { xPercent: -15 * 26, ease: Linear.easeNone },
        "motion-1"
      )
      .to(
        tarantula.current,
        0.725,
        { xPercent: -14 * 26, ease: Linear.easeNone },
        "motion-1+=0.75"
      )
      .to(
        tarantula.current,
        0.725,
        { xPercent: -13 * 26, ease: Linear.easeNone },
        "motion-1+=1.5"
      )
      .to(
        tarantula.current,
        0.725,
        { xPercent: -12 * 26, ease: Linear.easeNone },
        "motion-1+=2.25"
      )
      .to(
        tarantula.current,
        0.725,
        { xPercent: -11 * 26, ease: Linear.easeNone },
        "motion-1+=3"
      )
      .to(
        tarantula.current,
        0.725,
        { xPercent: -10 * 26, ease: Linear.easeNone },
        "motion-1+=3.75"
      )
      .to(
        tarantula.current,
        0.725,
        { xPercent: -9 * 26, ease: Linear.easeNone },
        "motion-1+=4.5"
      )
      .to(
        tarantula.current,
        0.725,
        { xPercent: -8 * 26, ease: Linear.easeNone },
        "motion-1+=5.25"
      )
      .to(
        tarantula.current,
        0.725,
        { xPercent: -7 * 26, ease: Linear.easeNone },
        "motion-1+=6"
      )
      .to(
        tarantula.current,
        0.725,
        { xPercent: -6 * 26, ease: Linear.easeNone },
        "motion-1+=6.75"
      )
      .to(
        tarantula.current,
        0.725,
        { xPercent: -5 * 26, ease: Linear.easeNone },
        "motion-1+=7.5"
      )
      .to(
        tarantula.current,
        0.725,
        { xPercent: -4 * 26, ease: Linear.easeNone },
        "motion-1+=8.25"
      )
      .to(
        tarantula.current,
        0.725,
        { xPercent: -3 * 26, ease: Linear.easeNone },
        "motion-1+=9"
      )
      .to(
        tarantula.current,
        0.725,
        { xPercent: -2 * 26, ease: Linear.easeNone },
        "motion-1+=9.75"
      )
      .to(
        tarantula.current,
        0.725,
        { xPercent: -1 * 26, ease: Linear.easeNone },
        "motion-1+=10.5"
      )
      .to(
        tarantula.current,
        0.725,
        { xPercent: 0 * 26, ease: Linear.easeNone },
        "motion-1+=11.25"
      )
      ...
      .add(
        legCycle(legB4, { raiseLate: true, moveFirst: true, repeat: 6 }),
        "motion-1"
      )
      ...
      .add(
        legCycle(legB1, { moveFirst: true, repeat: 0, steps: 2 }),
        "motion-2+=0.25"
      )
      .add(
        legCycle(legA1, { moveFirst: true, repeat: 0, steps: 2 }),
        "motion-2"
      )
      ...
      .to(
        body.current,
        0.25,
        { xPercent: -20, yPercent: -35, ease: Power1.easeOut },
        "motion-2+=0.375"
      )
      .to(
        [spinneretA.current, spinneretB.current],
        0.25,
        { rotation: -100, ease: Linear.easeNone },
        "motion-2+=0.375"
      )
      ...
      .add(
        animatePedipalpA.halfAttackStance(pedipalpA, 0.25),
        "motion-2+=0.375"
      )
      ...
      .add(
        animatePedipalpB.halfAttackStance(pedipalpB, 0.25),
        "motion-2+=0.375"
      );
    ...
    attackStanceTl
      ...
      .to(
        body.current,
        0.375,
        { xPercent: -10, yPercent: 10, ease: Power2.easeIn },
        "motion-3"
      )
      .to(
        [spinneretA.current, spinneretB.current],
      ...
      .add(
        animateLeg(legA1, 0.25, [
          -50,
          -122,
          tools.randomChoice([42, 47]),
          15,
          tools.randomChoice([10, 15, 26]),
          -15,
        ]),
      ...
      .add(
        animateLeg(legB1, 0.25, [
          -50,
          -143,
          tools.randomChoice([67, 62]),
          15,
          tools.randomChoice([10, 15, 20]),
          -10,
        ]),
        "motion-3+=0.25"
      )
      ...
      .add(
        animateLeg(legA3, 0.125, [-5, -73, 130, 15, 37, -10], 85, 250),
        "motion-4+=0.875"
      )
    ...
    completeTl
      ...
      .to(
        attackStanceTl,
        2.25,
        { progress: 1, ease: Power2.easeInOut },
        "enter+=11"
      )
      .to(
        singlePulseTl,
      ...
      .to(
        moveLegsTl,
        0.25,
        { progress: 1, repeat: -1, repeatDelay: 10, ease: Power2.easeInOut },
        "enter+=15.25"
      )
  ...
  return (
    <div
      ref={tarantulaWrapper}
      className={`tarantula-wrapper${
        isMobile ? " tarantula-wrapper--mobile" : ""
      }`}
    >
      <p ref={info} className="tarantula__info handwritten">
        <span className="tarantula__info__description">
          created with HTML5,
          <br />
          CSS and GSAP
        </span>
        <svg className="tarantula__info__arrow" viewBox="0 0 52 34" fill="none">
          <path
            d="M46.4576 1.32037C43.3078 10.8531 30.4555 28.15 4.24456 21.0754M4.24456 21.0754L14.3471 14.5008M4.24456 21.0754L11.7735 31.8898"
            stroke="white"
            strokeWidth="3"
          />
        </svg>
        ...
        <div ref={body} className={`x-body${glow ? " glow" : ""}`}>
          <div className="x-body-part x-cephalothorax">
            <div
              ref={legB2}
              id="legB2"
              className="x-leg x-leg--background leg-6"
            >
            ...
            <div
              ref={legB1}
              id="legB1"
              className="x-leg x-leg--background leg-5"
            >
              <div className="x-leg-parts x-coxa">
                <div className="x-leg-parts x-femur">
                  <div className="x-leg-parts x-patella">
            ...
            <div
              ref={legB3}
              id="legB3"
              className="x-leg x-leg--background x-leg--small leg-7"
            >
              <div className="x-leg-parts x-coxa">
                <div className="x-leg-parts x-femur">
                  <div className="x-leg-parts x-patella">
            ...
            <div
              ref={legB4}
              id="legB4"
              className="x-leg x-leg--background x-leg--small leg-8"
            >
              <div className="x-leg-parts x-coxa">
                <div className="x-leg-parts x-femur">
                  <div className="x-leg-parts x-patella">
            ...
            <div
              ref={pedipalpB}
              id="pedipalpB"
              className="x-leg x-leg--background x-pedipalp pedipalp-2"
            >
              <div className="x-leg-parts x-coxa">
                <div className="x-leg-parts x-femur">
                  <div className="x-leg-parts x-patella">
            ...
            <div
              ref={cheliceraeB}
              className="x-body-part x-chelicerae x-chelicerae--background"
            >
            ...
            <div ref={abdomen} className="x-body-part x-abdomen">
              <div
                ref={spinneretB}
                className="x-spinnerets x-spinnerets--background"
              >
              ...
              <div
                ref={spinneretA}
                className="x-spinnerets x-spinnerets--foreground"
              >
                <div className="x-spinnerets-parts x-coxa">
                  <div className="x-spinnerets-parts x-femur">
                    <div className="x-spinnerets-parts x-patella">
            ...
            <div
              ref={pedipalpA}
              id="pedipalpA"
              className="x-leg x-leg--foreground x-pedipalp pedipalp-1"
            >
              <div className="x-leg-parts x-coxa">
                <div className="x-leg-parts x-femur">
                  <div className="x-leg-parts x-patella">
            ...
            <div
              ref={legA4}
              id="legA4"
              className="x-leg x-leg--foreground x-leg--small leg-4"
            >
              <div className="x-leg-parts x-coxa">
                <div className="x-leg-parts x-femur">
                  <div className="x-leg-parts x-patella">
            ...
            <div
              ref={legA3}
              id="legA3"
              className="x-leg x-leg--foreground x-leg--small leg-3"
            >
              <div className="x-leg-parts x-coxa">
                <div className="x-leg-parts x-femur">
                  <div className="x-leg-parts x-patella">
            ...
            <div
              ref={legA1}
              id="legA1"
              className="x-leg x-leg--foreground leg-1"
            >
              <div className="x-leg-parts x-coxa">
                <div className="x-leg-parts x-femur">
                  <div className="x-leg-parts x-patella">
            ...
            <div
              ref={legA2}
              id="legA2"
              className="x-leg x-leg--foreground leg-2"
            >
              <div className="x-leg-parts x-coxa">
                <div className="x-leg-parts x-femur">
                  <div className="x-leg-parts x-patella">
