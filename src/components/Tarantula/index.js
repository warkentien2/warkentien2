...
function Tarantula({hideFrontLegs = false, hideBackLegs = false}) {
  ...
  useEffect(() => {
    walk
      ...
      .to(tarantula.current, 0.475, { xPercent: (-6 * 26), ease: Linear.easeNone }, 'motion-1+=0.625')
      .to(tarantula.current, 0.475, { xPercent: (-5 * 26), ease: Linear.easeNone }, 'motion-1+=1.125')
      .to(tarantula.current, 0.475, { xPercent: (-4 * 26), ease: Linear.easeNone }, 'motion-1+=2.125')
      .to(tarantula.current, 0.475, { xPercent: (-3 * 26), ease: Linear.easeNone }, 'motion-1+=2.625')
      .to(tarantula.current, 0.475, { xPercent: (-2 * 26), ease: Linear.easeNone }, 'motion-1+=3.625')
      .to(tarantula.current, 0.475, { xPercent: (-1 * 26), ease: Linear.easeNone }, 'motion-1+=4.125')
      .to(tarantula.current, 0.475, { xPercent: (0 * 26), ease: Linear.easeNone }, 'motion-1+=5.125')
      .to(tarantula.current, 0.475, { xPercent: (1 * 26), ease: Linear.easeNone }, 'motion-1+=5.625')
      .to(tarantula.current, 0.475, { xPercent: (2 * 26), ease: Linear.easeNone }, 'motion-1+=6.625')
      .to(tarantula.current, 0.475, { xPercent: (3 * 26), ease: Linear.easeNone }, 'motion-1+=7.125')
      .to(tarantula.current, 0.475, { xPercent: (4 * 26), ease: Linear.easeNone }, 'motion-1+=8.125')
      .to(tarantula.current, 0.475, { xPercent: (5 * 26), ease: Linear.easeNone }, 'motion-1+=8.625')
      .to(tarantula.current, 0.475, { xPercent: (6 * 26), ease: Linear.easeNone }, 'motion-1+=9.625')
      .to(tarantula.current, 0.475, { xPercent: (7 * 26), ease: Linear.easeNone }, 'motion-1+=10.125')
      .to(tarantula.current, 0.475, { xPercent: (8 * 26), ease: Linear.easeNone }, 'motion-1+=11.125')
    ;
    ...
    timeline.addLabel('motion-1', 'setup+=0.01')
      ...
      .add(legCycle(legA3, "moveFirst"), 'motion-1+=0.5')
      .add(legCycle(legB2, "moveFirst"), 'motion-1+=0.5')
      .add(legCycle(pedipalpA, "moveFirst"), 'motion-1+=0.5')
      .add(legCycle(legA1, "raiseLate", "moveFirst"), 'motion-1+=0.5')
      .add(legCycle(legB4, "raiseLate", "moveFirst"), 'motion-1+=0.5')
    ;
